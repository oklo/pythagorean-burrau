...
| The classical 3:4:5 Burrau problem ($u=1/3$) is nonperiodic; the conjecture holds for the primitive triple $(3,4,5)$ in both leg orderings | PROVED BY COMPUTER-ASSISTED ARGUMENT | Multi-passage LC covering certificate at 640-bit MPFR, tol $10^{-150}$, order 150; 18 rigorous LC passages incl. the $8.3\times10^{-5}$ encounter; escape margin $\ge0.9066$; `FABLE_BURRAU_THEOREM.md`, log in `data/fable/`; independent audit by the live agent requested |
