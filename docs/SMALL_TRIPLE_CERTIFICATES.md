...
| (5,12,13) | 1/5 | `13@0,auto` (43 automatic switches) | MP 400 bits, order 44, tol 1e-42 | PASS, margin 0.085, tp≈10.93, 9,140 steps, min selected 5.4e-6, min unselected 0.057, hull at machine zero throughout (`u_1_5_mp400_auto.log`); a single chart fails here, losing an unselected separation | MP 320 / order 36 / 1e-34: PASS (0.114) |
| (8,15,17) | 1/4 | `13@0,auto` (41 automatic switches) | MP 400 bits, order 44, tol 1e-42 | PASS, margin 0.089, tp≈19.52, 14170 steps, min selected 6.4e-05, min unselected 0.066 (`u_1_4_mp400_auto.log`); a single chart fails here | MP 320 / order 36 / 1e-34: PASS (0.095) |
