...
| Classical 3–4–5 problem `u=1/3` (fresh 2026-09-07 certificate) and (12,35,37) `u=1/6` | PROVED BY COMPUTER-ASSISTED ARGUMENT | [Small triples](SMALL_TRIPLE_CERTIFICATES.md); multiprecision `window_lc_capd`, logs in `data/fable/point_certs/`; independent replays at other precisions in progress. |
