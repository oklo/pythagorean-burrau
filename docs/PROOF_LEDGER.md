...
| Restricted transverse scattering invariant satisfies $\mathscr W_\infty>21/50$ | PROVED BY COMPUTER-ASSISTED ARGUMENT | Analytic half-line Jost tail enclosure plus CAPD propagation through $80\pi$; validated $k_+(0)>7/20$ and $k_+'(0)>3/5$ with stepwise certification of the upper launch's first outgoing leg |
