...
| Classical 3–4–5 problem `u=1/3` (fresh 2026-09-07 certificate), (12,35,37) `u=1/6`, and (39,80,89) `u=3/13` | PROVED BY COMPUTER-ASSISTED ARGUMENT | [Small triples](SMALL_TRIPLE_CERTIFICATES.md); multiprecision `window_lc_capd`, logs in `data/fable/point_certs/`; `u=1/3` and `u=1/6` replayed at other precisions, `u=3/13` replay in progress. |
