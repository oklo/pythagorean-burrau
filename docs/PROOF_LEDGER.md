...
| Infinitely many open skinny real parameter intervals, hence infinitely many primitive Pythagorean triples, are nonperiodic | PROVED ANALYTICALLY | Incoming-tail matching plus a fixed-margin restricted hyperbolic-escape arc and the terminal escape-or-collision certificate; collisions before section reach already exclude a classical period |
