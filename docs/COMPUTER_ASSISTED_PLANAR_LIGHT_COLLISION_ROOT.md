...
correlated verifier and starts from the full explicit parameter box (1), not
only the narrower interval-Newton root enclosure.  Its ten escape tiles now
cover the still larger interval
...
\(1.2679251755\le\kappa\le1.2679451755\), and a finite-mass
collision-or-escape neighborhood of that closed interval, are now classified
by the downstream theorem. Other
collision parameters and the
