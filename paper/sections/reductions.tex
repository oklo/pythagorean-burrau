...
escape at $t\simeq12.08$, and for $(12,35,37)$, through a temporary
$\{2,3\}$ binary of seventy revolutions and an exchange
(\path{docs/SMALL_TRIPLE_CERTIFICATES.md}; each native log is replayed at a
second Taylor order and tolerance). The
